    ...
    <Section title="My Music" description="Check out what I am currently listening to on Spotify">
      {data ? (
        <div className="flex flex-col items-center justify-center gap-4">
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="rounded-full bg-background p-3 text-2xl">
                    {data.isPlaying ? <IconPauseFill className="text-foreground" /> : <IconPlayFill className="text-foreground" />}
                  </div>
                </div>
              </motion.div>
            </AnimatePresence>
          ...
          <Link href={data.track.externalURL.spotify} target="_blank" rel="noreferrer">
